module "platform" {
  ...
  workload_identity_additional_service_account_names = var.workload_identity_additional_service_account_names
  key_vault_app_secrets                              = var.key_vault_app_secrets
  enable_model_storage                               = var.enable_model_storage
  model_storage_account_name                         = var.model_storage_account_name
  model_storage_replication_type                     = var.model_storage_replication_type
  blob_models_container                              = var.blob_models_container
  blob_registry_container                            = var.blob_registry_container
  blob_processed_container                           = var.blob_processed_container
